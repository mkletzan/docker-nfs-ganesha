...
LABEL org.opencontainers.image.url="https://github.com/mkletzan/docker-nfs-ganesha"
LABEL org.opencontainers.image.source="https://github.com/mkletzan/docker-nfs-ganesha"
