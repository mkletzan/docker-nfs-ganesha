...
- Documentation updated to reflect current version and features

### Security
- All GitHub Actions pinned to specific commit SHAs (supply chain security)
- Base image packages updated during build to apply latest security patches
- Dual security scanning: Grype (CI/CD) + Clair (continuous monitoring)
